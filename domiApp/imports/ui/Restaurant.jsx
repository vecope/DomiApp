...
export default class Restaurant extends Component {
   ...
   constructor(props){
       super(props);
       this.state={
           refe:"https://www.facebook.com/"+ this.props.restaurant.nombre+"/"
       }
   }
    ...
    render() {
        return (
            <div>
                <li>{this.props.restaurant.nombre}</li>
                ...
                <img src={this.props.restaurant.imagen}/>
                ...
                <div className="fb-like" data-href={this.state.refe} data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                <div className="fb-comments" data-href={this.state.refe} data-numposts="5"></div>
            </div>
